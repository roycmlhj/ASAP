  ...
  <div class="container d-flex justify-content-space-between" id="screen">
    <div class="d-flex align-items-stretch justify-content-between col-2">
      <div class="icon">
        ...
        <h4 class="exit" style="color: white;"><font-awesome-icon icon="fa-solid fa-door-closed" />exit</h4></router-link><!--수정-->
      </div>
      <div id="wrapper">
...
function none() {
  ...
  sendMessage2(msg);
  sendMessage3(msg);
  //setInterval(sendMessage(msg);,30000);
}

function callNone(){
  setInterval(none,30000);
}
